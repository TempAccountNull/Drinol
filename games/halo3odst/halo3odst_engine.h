...
namespace halo3odst::engine // Engine related structs, etc
{
	...
	{
	public:
		class _hs_script_op* table[1745]; //0x0000
	}; //Size: 0x3688
	static_assert(sizeof(_hs_function_table) == 0x3688);
	...
	{
	public:
		class hs_external_global* globals[1383]; //0x0000 The list of globals.
		// 466 is the hardcoded total number of globals in this array TODO: Fetch this dynamically somehow?
	}; //Size: 0x2930
	static_assert(sizeof(_hs_external_globals) == 0x2B38);
