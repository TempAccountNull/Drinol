...
namespace halo3
{
	...
	public:
		static inline std::unordered_map<std::string, std::string> list = {
			...
			{"rasterizer_game_states_member_index","89 05 ?? ?? ?? ?? 48 98 4C 89 64 24 38"},
			...
			{"draw_string_init","40 53 48 83 EC 20 48 8B D9 E8 ?? ?? ?? ?? 48 8D 05 ?? ?? ?? ?? 33 D2"},
			...
			{"font_cache_init","40 53 48 83 EC 20 8B 15 ?? ?? ?? ?? 48 8D 05"},
