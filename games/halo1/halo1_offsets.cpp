...
void halo1::offsets::init()
{
	...
	spdlog::debug("Halo 1: Pattern scanning for: hs_function_table");
	...
	spdlog::debug("Halo 1: Pattern scanning for: hs_external_globals");
	...
	spdlog::debug("Halo 1: Pattern scanning for: hs_type_names");
	...
	spdlog::debug("Halo 1: Pattern scanning for: game_ticks_per_second");
	...
	spdlog::debug("Halo 1: Pattern scanning for: ai_update_call");
