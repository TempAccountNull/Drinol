...
uint8_t* halo1::offsets::infinite_ammo;
...
void halo1::offsets::init()
{
	...
	bottomless_clip = reinterpret_cast<bool*>(reinterpret_cast<UINT_PTR>(baseaddress) + 0x1DE4891); //80 3D ?? ?? ?? ?? ?? B8 01 00 00 00 F3 44 0F 10 15
	infinite_ammo = reinterpret_cast<bool*>(reinterpret_cast<UINT_PTR>(baseaddress) + 0x1DE4876); //0F B6 05 ?? ?? ?? ?? EB 02 32 C0 88 05
