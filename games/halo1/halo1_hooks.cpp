...
void halo1::hooks::init_function_calls()
{
	...
	game_time_set_rate_scale_direct_og = reinterpret_cast<game_time_set_rate_scale_direct>(reinterpret_cast<char*>(halo1::offsets::game_time_set_rate_scale_direct));
}
...
{
	if (halo1::hooks::change_speed)
	{
		game_time_set_rate_scale_direct_og(ui::game_speed);

		halo1::hooks::change_speed = false;
	}

	return game_update_og(a1, a2);
}

inline void halo1::hooks::hook_game_update()
{
...
inline void halo1::hooks::unhook_game_update()
{
