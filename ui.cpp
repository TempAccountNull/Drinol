...
void menu_style()
{
	...
	colors[ImGuiCol_WindowBg] = ImVec4(0.00f, 0.34f, 0.37f, 0.94f);
	colors[ImGuiCol_ChildBg] = ImVec4(0.00f, 0.17f, 0.18f, 0.94f);
	...
	colors[ImGuiCol_TitleBg] = ImVec4(0.00f, 0.34f, 0.37f, 0.94f);
	colors[ImGuiCol_TitleBgActive] = ImVec4(0.00f, 0.62f, 0.68f, 0.94f);
